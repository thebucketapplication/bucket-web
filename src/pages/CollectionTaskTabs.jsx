...
import { getCollectionTasks } from '../redux/actions/taskActions'
import './TaskTab.css'
import ReactPlayer from 'react-player'
import FlatList from 'flatlist-react';

class CollectionTaskTabs extends Component {
  state = {
    active: 0,
    count: null
  }
  ...
  componentDidMount() {
    this.props.getCollectionTasks(this.props.collection.collectionID, null, true);
    this.props.getCollectionTasks(this.props.collection.collectionID, null, false);
  }

  fetchCompletedData() {
    this.props.getCollectionTasks(this.props.collection.collectionID, this.props.completed_last_visit, true);
  }

  fetchTodoData() {
    this.props.getCollectionTasks(this.props.collection.collectionID, this.props.todo_last_visit, false);
  }
        ...
        >
          ...
          >
            ...
            >
              to do
              (
              {this.props.collection.uncompletedBuckets
                ? this.props.collection.uncompletedBuckets
                : '0'}
              )
            </div>
          ...
          >
            ...
            >
              completed
              (
              {this.props.collection.completedBuckets
                ? this.props.collection.completedBuckets
                : '0'}
              )
            </div>
